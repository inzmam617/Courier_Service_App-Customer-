...
class Deliverd extends StatelessWidget {
  const Deliverd({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                InkWell(
                  onTap: () {Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) { return history(); }));},
                  child: Text(
                    "All",
          ...
          Padding(
            padding: const EdgeInsets.only(left: 150, right: 170),
            child: Container(
              height: .75,
